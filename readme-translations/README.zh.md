...
1. **启动 YTSage**
2. **粘贴 YouTube 链接** (或使用“粘贴 URL”按钮)
3. **点击“解析”**
4. **选择格式:**
   - `Video` 用于视频下载
   - `Audio` 用于音频提取
> 💡 您现在可以从“音频”区域选择并合并多个音轨到单个视频中。无论您是想将视频与多种语言音轨结合，还是想将多个音频流合并在一起。
5. **选择选项:**
   - 启用字幕并选择语言
   - 启用字幕合并
   - 保存缩略图
...
1. **粘贴播放列表 URL**
2. **点击“解析”**
3. **在播放列表选择器中选择视频 (可选，默认全选)**
4. **选择所需的格式/画质**
5. **点击“下载”**

> 💡 点击“播放列表另存为”按钮，您可以将播放列表条目导出为 (`.txt`、`.csv`、`.m3u` 或 `.json`) 文件。
