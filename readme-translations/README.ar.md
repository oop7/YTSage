...
1. **تشغيل YTSage**
2. **لصق رابط يوتيوب** (أو استخدام زر "لصق الرابط")
3. **النقر على "تحليل"**
4. **تحديد التنسيق:**
   - `Video` لتنزيل الفيديو
   - `Audio` لاستخراج الصوت
> 💡 يمكنك الآن تحديد ودمج عدة مسارات صوتية من قسم الصوت في فيديو واحد. سواء كنت ترغب في دمج فيديو مع مسارات بلغات متعددة، أو دمج عدة تدفقات صوتية معًا.
5. **اختر الخيارات:**
   - تمكين الترجمات واختيار اللغة
   - تمكين دمج الترجمة
   - حفظ الصورة المصغرة
   - إزالة المقاطع المروجة
   - حفظ الوصف
   - تضمين الفصول (الفصول، البيانات الوصفية، الصورة المصغرة)
...
1. **لصق رابط قائمة التشغيل**
2. **النقر على "تحليل"**
3. **تحديد الفيديوهات من محدد قائمة التشغيل (اختياري، افتراضيًا الكل)**
4. **اختيار التنسيق/الجودة المطلوبة**
5. **النقر على "تنزيل"**

> 💡 يمكنك تصدير عناصر قائمة التشغيل كملفات (`.txt` أو `.csv` أو `.m3u` أو `.json`) بالنقر على زر "حفظ قائمة التشغيل باسم".
