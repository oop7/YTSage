        ...
        if self.subtitle_langs:
            ...
            for sub_selection in self.subtitle_langs:
                try:
                    ...
                    logger.warning(f"Could not parse subtitle selection '{sub_selection}': {e}", exc_info=True)
        ...
        try:
            ...
            if self.merge_subs:
                try:
                    ...
                    logger.warning(f"Error scanning for initial subtitle files: {e}", exc_info=True)
